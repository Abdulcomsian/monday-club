                        ...
                        <div class="card mt-4 loginCard">
                            ...
                            <div class="card-body">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Monday Club Golf.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="emial" class="form-label">Email<span
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password"
                                                    ...
                                                    name="password" placeholder="password here..." id="password-input">
                                                <button
                                ...
                                <div class="text-center mt-3">
                                    <p class="text-muted">Don't have an account?
                                        <a href="{{ route('register') }}" class="text-primary" style="color:#e30b0b !important;">
                                            Sign up
                                        </a>
                                    </p>
                                </div>
